#!/usr/bin/env bash
# ═══════════════════════════════════════════════════════════
# ios/build_dev.sh — Build iOS DEV flavor
# Usage:
#   ./scripts/ios/build_dev.sh verify     # build nhanh, no-codesign, chỉ check code OK
#   ./scripts/ios/build_dev.sh ipa        # build .ipa thật để upload TestFlight
# ═══════════════════════════════════════════════════════════
...
case "$TARGET" in
  ...
  *)
    ...
    echo "Usage: ./scripts/ios/build_dev.sh [verify|ipa]"
    exit 1
    ;;
esac
